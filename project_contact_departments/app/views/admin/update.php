            ...
            <div class="card-body p-4">
              <div class="tab-content">
                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                  <form
                    action="<?= PATH.'/public/index.php?controller=employee&action=update&id='.$employee->getEmployeeId()?>"
                    method="post">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="phone"
                            value="<?= $employee->getMobilePhone() ?>" placeholder="Nhập số điện thoại">
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="position" placeholder="Công việc"
                      ...
                      <div class="col-lg-12">
                        <div class="hstack gap-2 justify-content-end">
                          <button type="submit" id="btnSaveProfile" class="btn btn-primary" name="update">Cập
                            nhật</button>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          <a href="javascript:void(0);" class="link-primary text-decoration-underline"
                            style="text-decoration: none;">Quên mật khẩu?</a>
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-12">
                        <div class="text-end">
                          <button type="button" id="btnChangePasswordProfile" class="btn btn-success">Lưu Thay
                            Đổi</button>
                        </div>
                      </div>
                      <!--end col-->
